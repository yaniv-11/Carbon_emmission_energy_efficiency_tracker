...
class EnergyEfficiencyModel:
    ...
    def preprocess_input(self, input_data):
        ...
        try:
            ...
            print(f"Error in preprocess_input method: {str(e)}")
    ...
    def predict(self, input_data):
        ...
        try:
            ...
            missing_fields = [field for field in self.FEATURE_ORDER if field not in input_data]
            if missing_fields:
            ...
            return {
                'CO2 Emitted (kg/hr)': float(prediction[0][0]),
                'Energy Used Efficiently (MJ)': float(prediction[0][1])
            }
        except Exception as e:
